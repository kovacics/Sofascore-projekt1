...
Route::register("play-quiz", new DefaultRoute("quiz-play", ['controller' => 'QuizPlayController', 'method' => 'play']));
...
Route::register("quizStats", new DefaultRoute("quiz-stats", ['controller' => 'QuizStatisticsController', 'method' => 'show']));
